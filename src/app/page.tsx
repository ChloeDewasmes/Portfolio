  ...
  return (
    <div className="bg-background-blue font-poppins px-6 sm:px-16 pt-2 sm:pt-6 overflow-hidden">
      ...
      <FadeInSection id="about">
        <h1 className="text-salmon-pink font-extrabold text-4xl sm:text-7xl">
          {text.about.title}
        </h1>
      ...
      >
        ...
        <SectionWave waveColor="#1B1F24" id="skills">
          <FadeInSection id="skills">
            <h1 className="text-salmon-pink font-extrabold text-4xl sm:text-7xl mb-6 pt-[5vh]">
              {text.skills.title}
            </h1>
      ...
      <FadeInSection id="projects">
        <h1 className="text-salmon-pink font-extrabold text-4xl sm:text-7xl mb-20 sm:mb-8">
          {text.projects.title}
        </h1>
        ...
        <SectionWave waveColor="#1B1F24" id="contact" showBottomWave={false}>
          <FadeInSection id="contact">
            ...
            <div className="relative z-10">
              <h1 className="text-salmon-pink font-extrabold text-4xl sm:text-7xl mt-[8vh]">
                contact.
              </h1>
